                            ...
                            <div class="cart-item">
                                <div class="row">
                                        ...
                                        <div class="quantity">
                                            <div class="input-group">
                                                <button type="button" wire: loading.attr="disabled"
                                                    ...
                                                    class="btn btn1"><i class="fa fa-minus text-black"></i></button>
                                                <input type="text" value="{{ $cartItem->quantity }} "
                                                    class="input-quantity" />
                                                <button type="button" wire: loading.attr="disabled"
                                                    wire:click="incrementQuantity({{ $cartItem->id }})"
                                                    class="btn btn1"><i class="fa fa-plus text-black"></i></button>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-1 my-auto">
                                    ...
                                    <div class="col-md-2 col-5 my-auto">
                                        <div class="remove">
                                            <a type="button" wire:click="removeCart({{ $cartItem->id }})"
